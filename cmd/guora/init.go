...
func initAll(conf *conf.Configuration) {
	...
	q1 := model.Question{Title: "這東西能做什麼？", Desc: `{"blocks":[{"key":"bvelr","text":"这个 Guora 要怎麼使用？","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}`, Type: 0, QuestionProfile: p0}
	q0.Create()
	q1.Create()
	...
	a1 := model.Answer{Content: `{"blocks":[{"key":"elb3v","text":"大家好，這是一個回答的範例，可以解釋我們的問題。","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"5nmjl","text":"首先Guora是一個私有部屬的社區回答系統。","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"dqjdg","text":"在部署後你可以輕鬆使用該問答平台，並且和你的工作夥伴社交互動。你也可以在這裡放置你的工作/學習文件。","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"alaje","text":"如果你是管理員，你可以進入管理頁面對系統進行管理。","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":14,"length":5,"style":"BOLD"}],"entityRanges":[{"offset":14,"length":4,"key":0}],"data":{}},{"key":"cr81h","text":"ps: 如果想要增加新用戶，目前只能通過管理員在管理頁面上手動增加。","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"length":36,"style":"ITALIC"},{"offset":26,"length":10,"style":"BOLD"}],"entityRanges":[{"offset":26,"length":4,"key":1}],"data":{}}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"href":"/admin","title":"/admin","url":"/admin"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"href":"/admin","title":"/admin","url":"/admin"}}}}`, Type: 0, QuestionID: q1.ID, AnswerProfileID: p0.ID}
	a0.Create()
	a1.Create()

	c0 := model.Comment{Content: "Comment here", Type: 0, AnswerID: a0.ID, CommentProfileID: p0.ID}
	c1 := model.Comment{Content: "在這邊留言"", Type: 0, AnswerID: a1.ID, CommentProfileID: p0.ID}
	c0.Create()
	c1.Create()

	r0 := model.Reply{Content: "Reply here", Type: 0, CommentID: c0.ID, ReplyFromProfile: p0, ReplyToProfile: p0}
	r1 := model.Reply{Content: "在這邊回覆", Type: 0, CommentID: c1.ID, ReplyFromProfile: p0, ReplyToProfile: p0}
	r0.Create()
	r1.Create()
